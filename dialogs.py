...
class Dialogs:
    ...
    GREETING_2 = "Вам поручили важную миссию по спасению мира. Итак, Вы попали " \
                 ...
                 " места происшествия, но нейтрализовать газ пока невозможно. " \
                 "Однако, там остались важные документы."

    WHY_ME = "почему я?"

    GREETING_3 = "Доставить эти документы можете только вы, наш главный и секретный агент. " \
                 "Итак, ваша задача, агент {} - вам " \
                 "нужно доставить эти документы. Как вы помните, ваш уникальный костюм способен " \
                 "выдержать любые нагрузки, даже взрыв ядерной бомбы. Однако, костюм не " \
                 "сможет закрыть ваше лицо, поэтому вы должны найти противогаз в Белом доме. " \
                 "Удачи солдат!"

    I_AM_READY = "я готов(а)"
